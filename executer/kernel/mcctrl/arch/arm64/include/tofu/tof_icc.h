...
#define TOF_ICC_REG_BCH_READY_STATE (1UL << (63))
...
#define TOF_ICC_REG_CQS_STATUS_DESCRIPTOR_PROCESS_STOP (1UL << (63))
#define TOF_ICC_REG_CQS_STATUS_DESCRIPTOR_FETCH_STOP (1UL << (62))
#define TOF_ICC_REG_CQS_STATUS_BLANK_ENTRY_FLIP_BIT (1UL << (61))
#define TOF_ICC_REG_CQS_STATUS_CACHE_FLUSH_BUSY (1UL << (60))
#define TOF_ICC_REG_CQS_STATUS_CQ_ENABLE (1UL << (59))
#define TOF_ICC_REG_CQS_STATUS_SESSION_DEAD (1UL << (58))
#define TOF_ICC_REG_CQS_STATUS_SESSION_OFFSET_OVERFLOW (1UL << (57))
...
#define TOF_ICC_REG_CQS_MODE_SYSTEM (1UL << (63))
#define TOF_ICC_REG_CQS_MODE_TRP2_ENABLE (1UL << (62))
#define TOF_ICC_REG_CQS_MODE_TRP1_ENABLE (1UL << (61))
#define TOF_ICC_REG_CQS_MODE_SESSION (1UL << (60))
...
#define TOF_ICC_REG_CQS_TCQ_IPA_CACHE_INJECTION (1UL << (63))
#define TOF_ICC_REG_CQS_MRQ_IPA 0x48
#define TOF_ICC_REG_CQS_MRQ_IPA_CACHE_INJECTION (1UL << (63))
...
#define TOF_ICC_REG_BGS_STATE_ENABLE (1UL << (0))
...
#define TOF_ICC_REG_BGS_SIGNAL_A_SIG_RECV (1UL << (63))
#define TOF_ICC_REG_BGS_SIGNAL_A_TLP_RECV (1UL << (62))
#define TOF_ICC_REG_BGS_SIGNAL_A_SIG_SEND (1UL << (61))
#define TOF_ICC_REG_BGS_SIGNAL_A_OP_TYPE GENMASK(3, 0)
#define TOF_ICC_REG_BGS_SIGNAL_B 0x50
#define TOF_ICC_REG_BGS_SIGNAL_B_SIG_RECV (1UL << (63))
#define TOF_ICC_REG_BGS_SIGNAL_B_TLP_RECV (1UL << (62))
#define TOF_ICC_REG_BGS_SIGNAL_B_SIG_SEND (1UL << (61))
...
#define TOF_ICC_REG_TNI_PRQ_PA_CACHE_INJECTION (1UL << (63))
...
#define TOF_ICC_REG_TOFU_NODE_ADDRESS_A (1UL << (7))
#define TOF_ICC_REG_TOFU_NODE_ADDRESS_B GENMASK(6, 5)
#define TOF_ICC_REG_TOFU_NODE_ADDRESS_C (1UL << (4))
...
/** Interrupts **/
#define TOF_ICC_IRQ_CQS_TOQ_READ_EXCEPTION (1UL << (0))
#define TOF_ICC_IRQ_CQS_TOQ_DIRECT_DESCRIPTOR_EXCEPTION (1UL << (1))
#define TOF_ICC_IRQ_CQS_TOQ_MARKED_UE (1UL << (2))
#define TOF_ICC_IRQ_CQS_TCQ_WRITE_EXCEPTION (1UL << (3))
#define TOF_ICC_IRQ_CQS_TOQ_SOURCE_TYPE_EXCEPTION (1UL << (4))
#define TOF_ICC_IRQ_CQS_TCQ_WRITE_ACKNOWLEDGE (1UL << (5))
#define TOF_ICC_IRQ_CQS_MRQ_WRITE_ACKNOWLEDGE (1UL << (7))
#define TOF_ICC_IRQ_CQS_MRQ_WRITE_EXCEPTION (1UL << (8))
#define TOF_ICC_IRQ_CQS_MRQ_OVERFLOW (1UL << (9))
#define TOF_ICC_IRQ_CQS_STEERING_READ_EXCEPTION (1UL << (36))
#define TOF_ICC_IRQ_CQS_MB_READ_EXCEPTION (1UL << (38))
#define TOF_ICC_IRQ_CQS_PAYLOAD_READ_EXCEPTION (1UL << (39))
#define TOF_ICC_IRQ_CQS_PAYLOAD_WRITE_EXCEPTION (1UL << (40))
/* Just for convinience of irr value, no exists CQS CACHEFLUSH_TIMEOUT interrupt  */
#define TOF_ICC_DUMMY_IRQ_CQS_CACHEFLUSH_TIMEOUT (1UL << (63))

#define TOF_ICC_IRQ_BGS_NODE_ADDRESS_UNMATCH (1UL << (0))
#define TOF_ICC_IRQ_BGS_BG_RECV_ADDRESS_EXCEPTION (1UL << (1))
#define TOF_ICC_IRQ_BGS_BG_SEND_ADDRESS_EXCEPTION (1UL << (2))
#define TOF_ICC_IRQ_BGS_GPID_UNMATCH (1UL << (3))
#define TOF_ICC_IRQ_BGS_BSEQ_UNMATCH (1UL << (4))
#define TOF_ICC_IRQ_BGS_SIGNAL_STATE_ERROR (1UL << (5))
#define TOF_ICC_IRQ_BGS_SYNCHRONIZATION_ACKNOWLEDGE (1UL << (24))
#define TOF_ICC_IRQ_BGS_ERROR_SYNCHRONIZATION_ACKNOWLEDGE (1UL << (25))
#define TOF_ICC_IRQ_BGS_DMA_COMPLETION_EXCEPTION (1UL << (26))

#define TOF_ICC_IRQ_TNI_PBQ_READ_EXCEPTION (1UL << (0))
#define TOF_ICC_IRQ_TNI_PBQ_MARKED_UE (1UL << (1))
#define TOF_ICC_IRQ_TNI_PBQ_UNDERFLOW (1UL << (2))
#define TOF_ICC_IRQ_TNI_PRQ_PACKET_DISCARD (1UL << (3))
#define TOF_ICC_IRQ_TNI_PRQ_WRITE_ACKNOWLEDGE (1UL << (4))
#define TOF_ICC_IRQ_TNI_PRQ_WRITE_EXCEPTION (1UL << (5))
#define TOF_ICC_IRQ_TNI_PRQ_OVERFLOW (1UL << (6))
#define TOF_ICC_IRQ_TNI_INACTIVE_BG (1UL << (16))
#define TOF_ICC_IRQ_TNI_STAGE2_TRANSLATION_FAULT (1UL << (32))

#define TOF_ICC_IRQ_TNR_TNR0_RX_FILTER_OUT (1UL << (0))
#define TOF_ICC_IRQ_TNR_TNR0_TX_FILTER_OUT (1UL << (1))
#define TOF_ICC_IRQ_TNR_TNR0_PORT_ERROR (1UL << (2))
#define TOF_ICC_IRQ_TNR_TNR0_DATELINE_ERROR (1UL << (3))
#define TOF_ICC_IRQ_TNR_TNR0_ROUTING_ERROR (1UL << (4))
#define TOF_ICC_IRQ_TNR_TNR1_RX_FILTER_OUT (1UL << (6))
#define TOF_ICC_IRQ_TNR_TNR1_TX_FILTER_OUT (1UL << (7))
#define TOF_ICC_IRQ_TNR_TNR1_PORT_ERROR (1UL << (8))
#define TOF_ICC_IRQ_TNR_TNR1_DATELINE_ERROR (1UL << (9))
#define TOF_ICC_IRQ_TNR_TNR1_ROUTING_ERROR (1UL << (10))
#define TOF_ICC_IRQ_TNR_TNR2_RX_FILTER_OUT (1UL << (12))
#define TOF_ICC_IRQ_TNR_TNR2_TX_FILTER_OUT (1UL << (13))
#define TOF_ICC_IRQ_TNR_TNR2_PORT_ERROR (1UL << (14))
#define TOF_ICC_IRQ_TNR_TNR2_DATELINE_ERROR (1UL << (15))
#define TOF_ICC_IRQ_TNR_TNR2_ROUTING_ERROR (1UL << (16))
#define TOF_ICC_IRQ_TNR_TNR3_RX_FILTER_OUT (1UL << (18))
#define TOF_ICC_IRQ_TNR_TNR3_TX_FILTER_OUT (1UL << (19))
#define TOF_ICC_IRQ_TNR_TNR3_PORT_ERROR (1UL << (20))
#define TOF_ICC_IRQ_TNR_TNR3_DATELINE_ERROR (1UL << (21))
#define TOF_ICC_IRQ_TNR_TNR3_ROUTING_ERROR (1UL << (22))
#define TOF_ICC_IRQ_TNR_TNR4_RX_FILTER_OUT (1UL << (24))
#define TOF_ICC_IRQ_TNR_TNR4_TX_FILTER_OUT (1UL << (25))
#define TOF_ICC_IRQ_TNR_TNR4_PORT_ERROR (1UL << (26))
#define TOF_ICC_IRQ_TNR_TNR4_DATELINE_ERROR (1UL << (27))
#define TOF_ICC_IRQ_TNR_TNR4_ROUTING_ERROR (1UL << (28))
#define TOF_ICC_IRQ_TNR_TNR5_RX_FILTER_OUT (1UL << (30))
#define TOF_ICC_IRQ_TNR_TNR5_TX_FILTER_OUT (1UL << (31))
#define TOF_ICC_IRQ_TNR_TNR5_PORT_ERROR (1UL << (32))
#define TOF_ICC_IRQ_TNR_TNR5_DATELINE_ERROR (1UL << (33))
#define TOF_ICC_IRQ_TNR_TNR5_ROUTING_ERROR (1UL << (34))
#define TOF_ICC_IRQ_TNR_TNR6_RX_FILTER_OUT (1UL << (36))
#define TOF_ICC_IRQ_TNR_TNR6_TX_FILTER_OUT (1UL << (37))
#define TOF_ICC_IRQ_TNR_TNR6_PORT_ERROR (1UL << (38))
#define TOF_ICC_IRQ_TNR_TNR6_DATELINE_ERROR (1UL << (39))
#define TOF_ICC_IRQ_TNR_TNR6_ROUTING_ERROR (1UL << (40))
#define TOF_ICC_IRQ_TNR_TNR7_RX_FILTER_OUT (1UL << (42))
#define TOF_ICC_IRQ_TNR_TNR7_TX_FILTER_OUT (1UL << (43))
#define TOF_ICC_IRQ_TNR_TNR7_PORT_ERROR (1UL << (44))
#define TOF_ICC_IRQ_TNR_TNR7_DATELINE_ERROR (1UL << (45))
#define TOF_ICC_IRQ_TNR_TNR7_ROUTING_ERROR (1UL << (46))
#define TOF_ICC_IRQ_TNR_TNR8_RX_FILTER_OUT (1UL << (48))
#define TOF_ICC_IRQ_TNR_TNR8_TX_FILTER_OUT (1UL << (49))
#define TOF_ICC_IRQ_TNR_TNR8_PORT_ERROR (1UL << (50))
#define TOF_ICC_IRQ_TNR_TNR8_DATELINE_ERROR (1UL << (51))
#define TOF_ICC_IRQ_TNR_TNR8_ROUTING_ERROR (1UL << (52))
#define TOF_ICC_IRQ_TNR_TNR9_RX_FILTER_OUT (1UL << (54))
#define TOF_ICC_IRQ_TNR_TNR9_TX_FILTER_OUT (1UL << (55))
#define TOF_ICC_IRQ_TNR_TNR9_PORT_ERROR (1UL << (56))
#define TOF_ICC_IRQ_TNR_TNR9_DATELINE_ERROR (1UL << (57))
#define TOF_ICC_IRQ_TNR_TNR9_ROUTING_ERROR (1UL << (58))
