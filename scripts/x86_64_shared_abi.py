...
REQUIRED_CONSTANTS = (
    ...
    "MCEXEC_UP_PREPARE_DMA", "MCEXEC_UP_FREE_DMA", "MCEXEC_UP_OPEN_EXEC",
    "MCEXEC_UP_CLOSE_EXEC", "MCEXEC_UP_SYS_MOUNT", "MCEXEC_UP_SYS_UMOUNT",
    "MCEXEC_UP_SYS_UNSHARE", "MCEXEC_UP_UTI_GET_CTX", "MCEXEC_UP_UTI_SWITCH_CTX",
    "MCEXEC_UP_SIG_THREAD", "MCEXEC_UP_SYSCALL_THREAD", "MCEXEC_UP_TERMINATE_THREAD",
