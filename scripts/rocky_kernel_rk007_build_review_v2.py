...
REUSED_MODULE_BINDINGS = {
    ...
    "rocky_kernel_rk007_build_review.py": (
        138177, "55dddf4b3f0137376f2a6ce6b37041e81fe89cd6e993bf685790435d48fe11fb"
    ),
}

# The ef58 review binds the exact parser implementations in REUSED_MODULE_BINDINGS.
# Active checkers are allowed to evolve, but those later bytes must never be
# substituted into this historical authority.  When a direct worktree file no
# longer has the frozen identity, recover only an exact Git blob allow-listed
# below.  This includes the previously reviewed v1 parser, whose current-port
# policy can evolve independently.  Every blob is rechecked against the frozen
# REUSED_MODULE_BINDINGS before it is executed.
REUSED_MODULE_HISTORICAL_BLOBS = {
    "rocky_kernel_rk007_build_review.py": (
        "a69c488f1a8690ce37ea16d13f7a0cd97ba4e629"
    ),
    "native_rust_kbuild_link_closure.py": (
...
REVIEW_SHA256 = '6534e52cdcd0346e2639b851f7df982159668853e492198d4c44281a6d2d0be5'
...
EXPECTED_CURRENT_OVERRIDES = [{'path': '.github/workflows/native-rust-host-modules-exact-build.yml',
  'mode': '100644',
  'current_sha256': '00c92532178894eb11bc0c39dd87cc9737ac34a606fc885bc19bb95b9baaf3e7',
  'current_size': 91530,
  'current_git_blob_sha1': '124a8e90781a4cbf06664ff5175410f0a91e61dd',
 ...
 {'path': 'host-kernel/kbuild/stage-manifest.json',
  'mode': '100644',
  'current_sha256': '5be2f97bd7e507e3e231d31fcb4d03304017f6833dec54e1f87137cf879f74ae',
  'current_size': 6468,
  'current_git_blob_sha1': 'b1ecb30effe1bc5b04f2eb877151ba54e8a0871d',
  'runtime_sha256': 'e41b6df1dcd0d8007b23a0795de596e5c775e84f10fe02cf08edd5d199cd4b7a',
  'runtime_size': 5743,
  'runtime_git_blob_sha1': 'a17f033fed694044a34e37f9f361ba75e37f6e7c'},
 ...
 {'path': 'host-kernel/native-rust/ihk.rs',
  'mode': '100644',
  'current_sha256': 'ea3720403482c66412b476d1e3dfeb1819f7397ba26f35d3aad62c47f1f0c73b',
  'current_size': 18630,
  'current_git_blob_sha1': '27e2ecdfa8dc461405556678e78c63b6094b2056',
 ...
 {'path': 'host-kernel/native-rust/ihk_ioctl.rs',
  'mode': '100644',
  'current_sha256': 'bfd645218062f6495ff352bb3e336f1448ea1109a5e440aee62ebe6394fe2958',
  'current_size': 9739,
  'current_git_blob_sha1': '14023d49f6f6eed142509cb1f2c9f0f53ca41456',
  'runtime_sha256': '3d603424705a9b0fb18725bae1d75f1d279b249b866c15f15f98166d013edfbb',
  'runtime_size': 9977,
  'runtime_git_blob_sha1': '200f4840bfa71521bbbac628d080c0d5f66df0a2'},
 {'path': 'host-kernel/native-rust/ihk_smp_x86_64.rs',
  'mode': '100644',
  'current_sha256': '6d95b42ec1007a8601cb0688ec29129bfcdd851be35c4d3c07b6a9ef5719dd32',
  'current_size': 19498,
  'current_git_blob_sha1': '2a2a93bbed58f4ab7be339b680f11c2cbb1257f0',
 ...
 {'path': 'scripts/rocky_rust_staging.py',
  'mode': '100644',
  'current_sha256': '16675ca75850107b72d6fe2839a1eedc10197e4d823e87651c673712cefcebbf',
  'current_size': 73896,
  'current_git_blob_sha1': 'b25f56e3d0239dd47198ef7223f31df8aa8f6d70',
  'runtime_sha256': '47d5c0005ae7e8217b723b2c5f1a1f321f90e7aa4d26000aa44ffbf25e426656',
  'runtime_size': 49797,
 ...
 {'path': 'scripts/native_rust_kbuild_link_closure.py',
  ...
  'runtime_sha256': '0d01fdbd437fe0d12b804784907c2208e40d3b45206297f4dd90de05411101f8',
  'runtime_size': 53824,
  'runtime_git_blob_sha1': '8b571f2c122ae8a6102e8ed83129f584701feea2'},
 {'path': 'scripts/native_rust_kconfig_solver.py',
  'mode': '100644',
  'current_sha256': 'fbb89bdb8766dcd446e8d75440c9e6bed1cf0a286107312510daef6626e80ab4',
  'current_size': 46669,
  'current_git_blob_sha1': '095bd7b985f05c540696bb614df06a66843e64ad',
  'runtime_sha256': '7a708375beb168f95ce6f6c76b96d47e70176a7f1654645aa99ca1275c9d7984',
  'runtime_size': 46054,
  'runtime_git_blob_sha1': '8211d19c56c56368718fe1420937fd5187530773'},
 {'path': 'scripts/rocky_kernel_rk007_build_review.py',
  'mode': '100644',
  'current_sha256': '423baf61f898ddbcae898d918190818282bca36ff6c856f50924d6e72fd71c47',
  'current_size': 138130,
  'current_git_blob_sha1': '3b875713090f1db1b87bb0d104d8aa3170ee9884',
