...
out = work / 'stability-transport-fault-run-20260913-prepublish-hard-1'
...
try:
    ...
    hashes = {
        'scripts/tests/run_stability_transport_guest.py': 'ca366a38d669f46f633bf4549b2eb54fa03f4ec1bd2567c29737d241f55f4a81',
        'scripts/tests/prepare_stability_fault_guest.py': '558113c02435a77eaf4b4623d96b9b5e16390fc3f646c31499caf3e93471b017',
    ...
    for name, status in (
            ('stability-fault-guest-root-20260913-prepublish-hard-1', 'PREPARED_NOT_EXECUTED'),
            ('stability-fault-guest-preflight-20260913-1', 'PASS_PREFLIGHT_NO_GUEST_EXECUTION'),
    ...
    bound = json.loads(binding.read_text()); assert bound['status'] == 'PASS'
    ...
    guest = work / 'stability-transport-fault-guest-20260913-prepublish-hard-1'
    argv = ['/usr/bin/python3', '-B', str(out / 'scripts/tests/run_stability_transport_guest.py'),
            '--prepared', '/work/stability-fault-guest-root-20260913-prepublish-hard-1', '--output', str(guest)]
