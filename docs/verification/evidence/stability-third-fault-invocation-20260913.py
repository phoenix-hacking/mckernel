...
out = work / 'stability-transport-fault-run-20260913-prepublish-hard-3'
...
try:
    ...
    hashes = {
        ...
        'scripts/tests/prepare_stability_fault_guest.py': 'e9f65c3946ebf49ffdba13fd4e6dea6c36aa03905d410c57fb119bd1901cbd5a',
    ...
    for name, status in (
            ...
            ('stability-fault-guest-root-20260913-prepublish-hard-2', 'PREPARED_NOT_EXECUTED'),
            ('stability-fault-guest-preflight-20260913-2', 'PASS_PREFLIGHT_NO_GUEST_EXECUTION'),
    ...
    guest = work / 'stability-transport-fault-guest-20260913-prepublish-hard-3'
    argv = ['/usr/bin/python3', '-B', str(out / 'scripts/tests/run_stability_transport_guest.py'),
            '--prepared', '/work/stability-fault-guest-root-20260913-prepublish-hard-2', '--output', str(guest)]
