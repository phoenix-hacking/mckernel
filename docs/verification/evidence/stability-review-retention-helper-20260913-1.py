...
work=Path('/work');out=work/'stability-review-retained-20260913-1';out.mkdir()
...
try:
    ...
    names=['stability-packet001-compile-20260913-1','stability-service-failure-stage-20260913-1','stability-service-failure-stage-20260913-2','stability-service-failure-tests-20260913-1']
    for i,name in enumerate(names):
        source=work/name; child=json.loads((source/'record.json').read_text())
        assert child['status']==['PASS','FAIL','STAGED_NOT_RUN','FAIL'][i]
        archive=out/('stability-review-20260913-1-'+str(i+1).zfill(2)+'.tar.gz')
