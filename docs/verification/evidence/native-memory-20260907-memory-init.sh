...
# Keep informational printk traffic from splitting userspace success markers.
# finish() emits the complete ring buffer; the validator still checks it for
# warnings, oopses and panics. Kernel errors remain visible on the live console.
