...
/*
 * Perf ioctl command values. These constants preserve the legacy McKernel
 * _IO('$', nr) encoding without exposing local ioctl-constructor macros.
 */
#define PERF_EVENT_IOC_ENABLE           0x00002400U
#define PERF_EVENT_IOC_DISABLE          0x00002401U
#define PERF_EVENT_IOC_REFRESH          0x00002402U
#define PERF_EVENT_IOC_RESET            0x00002403U
