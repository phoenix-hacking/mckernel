...
pid_t xpmem_segid_to_tgid(xpmem_segid_t segid);
pid_t xpmem_apid_to_tgid(xpmem_apid_t apid);
...
int xpmem_tg_hashtable_index(pid_t tgid);
int xpmem_ap_hashtable_index(xpmem_apid_t apid);
